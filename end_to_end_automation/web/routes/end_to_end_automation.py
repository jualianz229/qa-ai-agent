...
from core.common.dashboard_data import build_run_detail, list_runs, sort_runs
from core.common.jobs import get_job, get_all_jobs, is_duplicate_recent_job
from core.common.utils import form_bool, is_automation_or_recovery_run, is_automation_run
from end_to_end_automation.src.recovery import (
    create_recovery_job,
...
from end_to_end_automation.src.automation import create_automation_job
from end_to_end_automation.web.features.end_to_end_automation import (
    build_automation_results_context,
    build_end_to_end_automation_context,
)

bp = Blueprint("end_to_end_automation", __name__)
...
def create_automation_job_api():
    from dashboard import _resolve_run_dir
...
def retry_failed_job_api(run_name: str):
    from dashboard import _append_recovery_action
    executor_headed = form_bool(request.form.get("executor_headed"), default=False)
    try:
