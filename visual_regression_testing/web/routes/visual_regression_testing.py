...
from core.common.jobs import create_job, is_duplicate_recent_job
from core.common.utils import form_bool, normalize_input_url, load_json_file, resolve_run_dir
from visual_regression_testing.src.visual_regression import save_visual_approval
from visual_regression_testing.web.features.visual_regression_testing import (
    build_vrt_changes_context,
    build_vrt_monitor_context,
    build_vrt_scan_context,
)

bp = Blueprint("visual_regression_testing", __name__)
