...
from core.common.config import INSTRUCTIONS_DIR, RESULT_DIR
from core.common.dashboard_data import list_runs, sort_runs
...
from core.common.jobs import create_job, get_all_jobs, get_job, is_duplicate_recent_job
from core.common.utils import form_bool, normalize_input_url
from test_case_generator.web.features.test_case_generator import (
    build_all_test_cases_context,
    build_test_case_generator_context,
)

bp = Blueprint("test_case_generator", __name__)
