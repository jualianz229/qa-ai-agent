...
from core.common.feedback_bank import load_run_feedback
from core.common.site_profiles import load_knowledge_bank_snapshot
...
def build_benchmark_snapshot(results_dir: str | Path = "Result", limit: int = 8) -> dict:
    from core.common.benchmark import BenchmarkCase, run_benchmark_suite
